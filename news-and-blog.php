                    ...
                    <div class="col-lg-5 col-12 col-xm-12">
                        <div class="top-left-items">
                            <ul>
                                ...
                                <li><i class='bx bxs-envelope'></i> <a href="#">info@hindusthan.net</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class='nav-link active' href='news-and-blog.php'>News and Blog</a></li>
            ...
            <div class="container">
                <div class="banner-spacing">
                    <div class="section-info">
                        ...
                        <p data-aos="fade-up" data-aos-delay="200">Catch up on the latest happenings, achievements, and important updates from Hindusthan Educational Institutions.</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="news-item" style="border: 2px solid #ff6b00;">
                                ...
                                <div class="news-content">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a href="blog-details.php?id=<?php echo $special_event['id']; ?>" class="btn btn btn-sm" style="color: #ff6b00; border-color: #ff6b00;">
                            ...
                            <div class="news-container" id="latest-news">
                                ...
                                <div class="news-item">
                                    ...
                                    <div class="news-content">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="blog-details.php?id=<?php echo $row['id']; ?>" class="btn btn btn-sm" style="color: #ff6b00; border-color: #ff6b00;">
                                                View More <i class="fas fa-arrow-right ms-1"></i>
                                            </a>
                                            <i class="fas fa-share-alt share-icon"></i>
                                        </div>
                                ...
                                <nav aria-label="Page navigation" class="mt-4" id="latest-pagination">
                                    <ul class="pagination justify-content-center">
                                        <?php if ($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="#" data-page="<?php echo $page - 1; ?>" data-container="latest" aria-label="Previous">
                                        ...
                                        <li class="page-item <?php echo $i === $page ? 'active' : ''; ?>">
                                            <a class="page-link" href="#" data-page="<?php echo $i; ?>" data-container="latest"><?php echo $i; ?></a>
                                        </li>
                                        <?php endfor; ?>

                                        <?php if ($page < $total_pages): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="#" data-page="<?php echo $page + 1; ?>" data-container="latest" aria-label="Next">
                            ...
                            <div class="news-container hidden" id="past-news">
                                ...
                                <nav aria-label="Page navigation" class="mt-4" id="past-pagination">
                                    <ul class="pagination justify-content-center">
                                        <?php if ($past_page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="#" data-page="<?php echo $past_page - 1; ?>" data-container="past" aria-label="Previous">
                                                <span aria-hidden="true">&laquo;</span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                                        ...
                                        <li class="page-item <?php echo $i === $past_page ? 'active' : ''; ?>">
                                            <a class="page-link" href="#" data-page="<?php echo $i; ?>" data-container="past"><?php echo $i; ?></a>
                                        </li>
                                        <?php endfor; ?>

                                        <?php if ($past_page < $past_total_pages): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="#" data-page="<?php echo $past_page + 1; ?>" data-container="past" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
                                        </li>
                                        <?php endif; ?>
