                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class='nav-link active' href='blog-details.php'>Blog Details</a>
                                </li>
        ...
        <div class="container">
            <div class="banner-spacing">
                <div class="section-info">
                    ...
                    <p data-aos="fade-up" data-aos-delay="200">Explore the full story and insights behind this blog post
                        in a simple and engaging way.</p>
                </div>
            </div>
        </div>
    </div>
